...
const CategoryIcons = {
  ...
  Formación: (
    <svg
      ...
      className="text-primary h-6 w-6 opacity-70"
    >
      <path d="M12 2L1 7l11 5 9-4.09V17h2V7L12 2zm0 9L3.74 7 12 3.74 20.26 7 12 11zm-5 2.09L1 10v4l6 3 6-3v-4l-6 3.09z"></path>
    </svg>
  ),
  "Cómo trabajo en equipo": (
    <svg
      ...
      className="text-primary h-6 w-6 opacity-70"
    >
      <path d="M12 2C9.24 2 7 4.24 7 7s2.24 5 5 5 5-2.24 5-5S14.76 2 12 2zm-9 17c0-2.5 5-3.88 9-3.88S21 16.5 21 19v1H3v-1z"></path>
    </svg>
  ),
};
